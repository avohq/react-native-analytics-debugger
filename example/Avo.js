// Generated by Avo VERSION 45.25.0, PLEASE EDIT WITH CARE
/* eslint-disable */
...
function _avo_invoke_meta(type, messages) {
  ...
  function appOpened(properties) {
    ...
    if (__AVO_DEV__ || __MOBILE_DEBUGGER__ !== null) {
      ...
      // debug console in Avo
      _avo_invoke("oZvpnm2MM", "38946bd6e1f82fafe53f39b62e7817d36983768b98bc6f49cd13e2165665803b", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId}); }));
  ...
  function play(properties) {
    ...
    if (__AVO_DEV__ || __MOBILE_DEBUGGER__ !== null) {
      ...
      // debug console in Avo
      _avo_invoke("6p9dLEHQVr", "daf6e996975e2e4ba1c72c60ba654e667d1df7b23667608ae2de51087798c4aa", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId}); }));
  ...
  function pause(properties) {
    ...
    if (__AVO_DEV__ || __MOBILE_DEBUGGER__ !== null) {
      ...
      // debug console in Avo
      _avo_invoke("Ei7HeAerpy", "c7f744d5b1df717853c6116b65fd2a418a31be2810b80dc41c55d9046fa2abcc", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId}); }));
  ...
  function playNextTrack(properties) {
    ...
    if (__AVO_DEV__ || __MOBILE_DEBUGGER__ !== null) {
      ...
      // debug console in Avo
      _avo_invoke("rQvcOWggzs", "100026f6e39b8f2383cdd8cc80cb27f99d89d31931662c6724f3b6337341fccb", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId}); }));
  ...
  function playPreviousTrack(properties) {
    ...
    if (__AVO_DEV__ || __MOBILE_DEBUGGER__ !== null) {
      ...
      // debug console in Avo
      _avo_invoke("xBjjLugyOM", "c446c1687498d1c46cf3eb2820747855f6cb0817934b6f3fa0ebc579261acb41", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId}); }));
